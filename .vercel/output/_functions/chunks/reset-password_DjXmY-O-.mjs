...
import { r as renderScript } from './global_Dj8FxnUX.mjs';
...
Guardar Contraseña
</button> <p id="message-container" class="text-sm text-center font-medium mt-4"></p> </form> </div> </main> ` })} ${renderScript($$result, "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/pages/reset-password.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/pages/reset-password.astro", void 0);

const $$file = "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/pages/reset-password.astro";
