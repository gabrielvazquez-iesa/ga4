      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm shadow-xl", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 pt-6 border-t border-slate-200 dark:border-white/10", children: [
            ...
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => toast.success("Preparado para arquitectura WebAuthn en próxima fase."), className: "flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 font-medium transition-colors text-sm", children: "Activar Passkey en este dispositivo" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white/80 dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 rounded-2xl p-6 md:p-8 backdrop-blur-sm shadow-xl", children: [
