    ...
    /* @__PURE__ */ jsx(Dialog, { open: showModal, onOpenChange: setShowModal, children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-xl bg-slate-50 dark:bg-[#0f172a] border-slate-200 dark:border-white/10 rounded-2xl", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSave, className: "space-y-5 pt-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 flex flex-col", children: [
            /* @__PURE__ */ jsx("label", { className: "text-xs font-bold text-slate-500 uppercase tracking-widest", children: "Inicio *" }),
            /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
              /* @__PURE__ */ jsx(Calendar, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none z-10" }),
              /* @__PURE__ */ jsx(
                DatePicker,
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-1.5 flex flex-col", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
              /* @__PURE__ */ jsx(Clock, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 pointer-events-none z-10" }),
              /* @__PURE__ */ jsx(
                DatePicker,
                {
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("svg", { className: `w-4 h-4 text-slate-400 transition-transform duration-200 ${open ? "rotate-180" : ""}`, fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M19 9l-7 7-7-7" }) })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxs("div", { className: "absolute z-[100] w-full mt-2 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-slate-300 dark:[&::-webkit-scrollbar-thumb]:bg-slate-700/50 [&::-webkit-scrollbar-thumb]:rounded-full", children: [
      ...
      options.map((o) => /* @__PURE__ */ jsx(
        "button",
        {
          ...
          className: `w-full text-left px-4 py-3 text-sm transition-colors ${o.value === value ? "bg-indigo-600/10 text-indigo-400 font-bold border-l-2 border-indigo-500" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 font-medium border-l-2 border-transparent"}`,
          children: o.label
        },
        o.value
      ))
