...
function Sidebar({ currentPath }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("nav", { className: "md:hidden fixed bottom-6 left-4 right-4 bg-slate-900/95 dark:bg-slate-800/95 backdrop-blur-xl border border-slate-700 dark:border-white/10 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] rounded-[2rem] p-2 flex items-center justify-between z-50", children: [
      menuItems.filter((item) => item.name !== "Notificaciones").slice(0, 5).map((item) => {
        ...
        return /* @__PURE__ */ jsx(
          ...
          {
            href: item.path,
            className: `relative flex items-center justify-center rounded-full transition-all duration-300 ease-in-out h-12 ${isActive ? "bg-white text-slate-900 flex-1 px-4 shadow-[0_2px_10px_rgba(255,255,255,0.2)]" : "w-[3.5rem] text-slate-400 hover:text-white bg-transparent"}`,
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-1.5 shrink-0 h-full w-full", children: [
              /* @__PURE__ */ jsx(
                item.icon,
                {
              ...
              /* @__PURE__ */ jsx("div", { className: `transition-all duration-300 ease-in-out overflow-hidden flex items-center ${isActive ? "max-w-[100px] opacity-100 ml-1" : "max-w-0 opacity-0 ml-0"}`, children: /* @__PURE__ */ jsx("span", { className: "text-sm font-extrabold tracking-tight truncate", style: isActive && customColor ? { color: customColor } : {}, children: item.name.split(" ")[0] }) })
            ] })
          },
          item.path
        );
      }),
      /* @__PURE__ */ jsx("div", { className: "h-8 w-px bg-slate-700/50 mx-1 shrink-0" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: handleLogout,
          ...
          children: /* @__PURE__ */ jsx(LogOut, { className: "w-5 h-5 shrink-0" })
        }
      )
    ] })
  ] });
...
const $$DashboardLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"><title>', '</title><link rel="manifest" href="/manifest.json"><meta name="theme-color" content="#3b82f6"><link rel="apple-touch-icon" href="/favicon.svg">', "<script>\n      if ('serviceWorker' in navigator) {\n        window.addEventListener('load', () => {\n          navigator.serviceWorker.register('/sw.js').catch(err => console.error('SW Error', err));\n        });\n      }\n    <\/script><script>\n      const getTheme = () => {\n        if (typeof localStorage !== 'undefined' && localStorage.getItem('theme')) {\n          return localStorage.getItem('theme');\n        }\n        return window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light';\n      };\n\n      const applyTheme = () => {\n        const theme = getTheme();\n        if (theme === 'dark') {\n          document.documentElement.classList.add('dark');\n        } else {\n          document.documentElement.classList.remove('dark');\n        }\n      };\n\n      applyTheme();\n      document.addEventListener('astro:after-swap', applyTheme);\n    <\/script>", '</head> <body class="bg-slate-50 text-slate-900 dark:bg-[#050B14] dark:text-slate-300 antialiased min-h-screen opacity-0 transition-opacity duration-500" id="dashboard-body"> <!-- Sidebar for Desktop --> ', ' <!-- Main Content Wrapper --> <div id="main-content" class="md:pl-64 flex flex-col min-h-screen transition-all duration-300 ease-in-out"> ', ' <main class="flex-1 p-4 pb-32 md:p-8 md:pb-8"> ', " </main> </div> <!-- Script to protect routes (Redirect if not logged in) --> ", " </body> </html>"])), title, renderComponent($$result, "ClientRouter", $$ClientRouter, {}), renderHead(), renderComponent($$result, "Sidebar", Sidebar, { "client:load": true, "currentPath": currentPath, "client:component-hydration": "load", "client:component-path": "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/components/Sidebar", "client:component-export": "default" }), renderComponent($$result, "Topbar", Topbar, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/components/Topbar", "client:component-export": "default" }), renderSlot($$result, $$slots["default"]), renderScript($$result, "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/layouts/DashboardLayout.astro?astro&type=script&index=0&lang.ts"));
}, "C:/Users/gabriel.vazquez/Desktop/Proyectos/proyecto-dashboard/ga4-dashboard/src/layouts/DashboardLayout.astro", void 0);
