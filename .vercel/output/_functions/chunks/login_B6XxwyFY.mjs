...
Volver al inicio
</a> <!-- Auth Form Island --> ${renderComponent($$result2, "AuthForm", AuthForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "G:/Proyectos/GA4/src/components/AuthForm", "client:component-export": "default" })} </main> ` })}`;
}, "G:/Proyectos/GA4/src/pages/login.astro", void 0);

const $$file = "G:/Proyectos/GA4/src/pages/login.astro";
const $$url = "/login";
