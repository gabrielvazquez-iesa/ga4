...
import { Activity, Users, Percent, ArrowUpRight, ArrowDownRight, Target, Clock, MousePointerClick, Gauge, FileText, Search, ExternalLink, Eye, TrendingUp, TrendingDown, Minus, BarChart2, Download, RefreshCw } from 'lucide-react';
...
function ContentListModule({ days, filterPath }) {
  ...
  const processedData = useMemo(() => {
    ...
    if (searchQuery) {
      ...
      result = result.filter(
        (item) => item.title && item.title.toLowerCase().includes(q) || item.path && item.path.toLowerCase().includes(q)
      );
    }
    result = [...result].sort((a, b) => {
      switch (sortBy) {
        ...
        case "date-asc":
          ...
          if (valA === valB) return b.views - a.views;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-white/10 rounded-2xl shadow-xl backdrop-blur-sm overflow-hidden flex flex-col h-full mt-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "p-6 border-b border-slate-200 dark:border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 w-full md:w-auto overflow-visible z-50", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-36 hidden sm:block", children: /* @__PURE__ */ jsx(
          CustomSelect,
          {
            value: sortBy,
            onChange: setSortBy,
        ...
        /* @__PURE__ */ jsx("div", { className: "w-24 hidden sm:block", children: /* @__PURE__ */ jsx(
          CustomSelect,
          {
    ...
    /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-sm text-slate-600 dark:text-slate-300", children: [
      ...
      /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-white/5", children: loading ? Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxs("tr", { className: "animate-pulse", children: [
        ...
        /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "h-4 bg-slate-200 dark:bg-slate-800 rounded w-16 mx-auto" }) })
      ] }, i)) : processedData.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 3, className: "px-6 py-12 text-center text-slate-500", children: searchQuery ? "No hay resultados para tu búsqueda." : "No se encontró contenido publicado en este período." }) }) : processedData.map((item, i) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: "relative w-full", children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("span", { className: "truncate mr-2", children: selected?.label }),
          /* @__PURE__ */ jsx("svg", { className: `w-3.5 h-3.5 text-slate-400 transition-transform duration-200 shrink-0 ${open ? "rotate-180" : ""}`, fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M19 9l-7 7-7-7" }) })
        ]
      }
    ),
    open && /* @__PURE__ */ jsx("div", { className: "absolute z-[100] right-0 w-[140%] mt-2 bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/10 rounded-xl shadow-2xl overflow-hidden max-h-60 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-slate-300 dark:[&::-webkit-scrollbar-thumb]:bg-slate-700 [&::-webkit-scrollbar-thumb]:rounded-full", children: options.map((o) => /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        className: `w-full text-left px-4 py-2.5 text-sm transition-colors ${o.value === value ? "bg-blue-500/10 text-blue-600 dark:text-blue-400 font-bold border-l-2 border-blue-500" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 font-medium border-l-2 border-transparent"}`,
        children: o.label
      },
      o.value
    )) })
